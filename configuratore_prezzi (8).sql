...
--
-- Host: localhost
-- Generation Time: Lug 28, 2014 alle 22:41
...
(2, 'M-Track', '2014-06-09', 600, 24, 48, 0, '80000000001', 'PROLUNGA MINITRACK LED L=700mm (xREEL)', 'PZ', 1, 1.8, '2014-07-28'),
(3, 'Sliding', '2014-06-09', 0, 24, 48, 0, '80000000002', 'N.2 TESTATE SLIDING + CONTATTI (xREEL)', 'PZ', 1, 3.29, '2014-07-28'),
(4, 'Modular', '2014-06-09', 500, 24, 48, 0, '80000000003', 'PROLUNGA MODULAR LED L=600mm (xREEL)', 'PZ', 1, 1.9, '2014-07-28');
...
('inserimento giunzione MF, poi è da codificare ma al momento rimane così', 0, 0, 0.4, 'PZ', 1, 'GIUNZIONE MF'),
...
('MALINDI', 160, '81110391000', 'ETIC.13x35mm ''12VDC MAX1,5A''', 'PZ', 1, 0, '2013-05-03'),
...
INSERT INTO `regole_imballi` (`da`, `a`, `ordine`, `codice_articolo_imballo`, `descrizione_imballo`, `UM`, `coefficente_utilizzo`, `quantita`, `costo`, `inzio_validita`) VALUES
...
(1250, 1549, 190, '50100120100', 'SCAT.IMB.SING.FREEDOM 35W (1550*46*34)', 'PZ', 1, 1, 0.5, '2012-11-19'),
(1250, 1549, 200, '50100130600', 'SCAT.IMB.MULTIPLO FREEDOM 35W', 'PZ', 10, 1, 0.5, '2012-11-19'),
(1550, 1999, 200, '41400630000', 'TAPPO IN PLASTICA xTUBOLARE', 'PZ', 1, 2, 0, '2013-05-03'),
(1550, 1999, 190, '50101510600', 'TUBOLARE IN CARTONE D40mm L2mt', 'PZ', 1, 1, 0.5, '2012-11-19'),
(2000, 3000, 200, '41400630000', 'TAPPO IN PLASTICA xTUBOLARE', 'PZ', 1, 2, 0, '2013-05-03'),
(2000, 3000, 190, '50101520600', 'TUBOLARE IN CARTONE D40mm L3mt', 'PZ', 1, 1, 0.5, '2012-11-19');
...
('GENEVE', 'NA', 20, '0000000000', 'NESSUN SCHERMO', 'PZ', 1, 0, 0, '2014-07-28'),
('GENEVE', 'OP', 20, '40301990100', 'SCHERMO PRODOTTI XL L=3mt VERGA OPALE768', 'PZ', 1, 1.56, 0, '2014-07-28'),
('GENEVE', 'TR', 20, '40301990000', 'SCHERMO PRODOTTI XL L=3mt TRASPARENTE656', 'PZV', 1, 1.56, 0, '2014-07-24'),
...
('LUGANO', 'TR', 20, '40301990000', 'SCHERMO PRODOTTI XL L=3mt TRASPARENTE656', 'PZV', 1, 0, 0, '2013-04-22'),
...
('MALINDI', 'OP', 20, '40301920100', 'SCHERMO MALINDI OPALE SPORGENTE 3mt', 'PZV', 1, 0, 0, '2013-04-22'),
('MALINDI', 'OP', 20, '40301920100', 'SCHERMO MALINDI OPALE MATTATO 3mt (satinato in ma)', 'PZ', 1, 1.56, 0, '2014-07-28'),
('MALINDI', 'TR', 20, '40301920000', 'SCHERMO MALINDI TRASP. SPORGENTE 3mt', 'PZV', 1, 0, 0, '2013-04-22'),
('MALINDI', 'TR', 20, '40301990000', 'SCHERMO PRODOTTI XL L=3mt TRASPARENTE656', 'PZ', 1, 1.56, 0, '2014-07-28'),
...
('MANILA', 'OP', 20, '40301990100', 'SSCHERMO PRODOTTI XL L=3mt VERGA OPALE768', 'PZV', 1, 0, 0, '2013-04-22'),
...
('PERTH', 'OP', 20, '40301990100', 'SCHERMO PRODOTTI XL L=3mt VERGA OPALE768', 'PZ', 1, 1.56, 0, '2014-07-28'),
('PERTH', 'TR', 20, '40301990000', 'SCHERMO PRODOTTI XL L=3mt TRASPARENTE656', 'PZV', 1, 1.56, 0, '2014-07-24'),
...
('LEDO', 0.05, 1, 74, 'F01010400458', 'VITE AUTOFILE 2.9X16mm TC', '', 'PZ', 0, 1000, '2', '2014-07-24'),
('LEDO', 0.05, 1, 74, 'F1010400458', 'VITE AUTOFIL  2.9X16cm', '', 'PZ', 1001, 2000, '3', '2014-07-25'),
('LEDO', 0.05, 1, 74, 'F1010400458', 'VITE AUTOFIL  2.9X16cm', '', 'PZ', 2001, 3000, '4', '2014-07-25'),
('LEDO', 0.14, 2, 73, '40402580000', 'CLIPS FISS su vetro ledo', '', 'PZ', 0, 1000, '2', '2014-07-24'),
('LEDO', 0.14, 2, 73, '40402580000', 'CLIPS FISS su vetro ledo', '', 'PZ', 1001, 2000, '3', '2014-07-25'),
('LEDO', 0.14, 2, 73, '40402580000', 'CLIPS FISS su vetro ledo', '', 'PZ', 2001, 3000, '4', '2014-07-25'),
...
(6, 'PIR MURATA', 'PM', '2A', 24, 48, '', 0, 8.41, '80707160101');
...
ALTER TABLE `regole_imballi`
 ADD PRIMARY KEY (`da`,`a`,`codice_articolo_imballo`,`inzio_validita`), ADD KEY `da` (`da`), ADD KEY `a` (`a`);
