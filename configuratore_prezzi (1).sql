...
--
-- Host: localhost
-- Generation Time: Giu 10, 2014 alle 18:28
...
CREATE TABLE IF NOT EXISTS `connettore_alimentazione` (
  `id_connettore` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK per il connettore di alimentazione',
...
CREATE TABLE IF NOT EXISTS `prodotto_lineare_motore_led_accensione` (
  ...
  PRIMARY KEY (`prodotto_lineare`,`motore_led`,`id_sistema_accensione`,`id_sistema_fissaggio`,`id_connettore`),
  ...
  KEY `id_connettore` (`id_connettore`)
